...
export function TripItineraryModal({ trip, open, onOpenChange }: TripItineraryModalProps) {
    if (!trip) return null;
                    ...
                    <div className="grid md:grid-cols-[1fr,300px] gap-8 p-8">
                            ...
                            <div className="relative border-l border-white/10 ml-3 space-y-8 pb-10">
                                {trip.itinerary.map((day, index) => (
                                    <div key={index} className="relative pl-8">
                                        ...
                                        <div className="mb-1">
                                            <span className="text-xs font-bold text-teal-400 uppercase tracking-wider">Day {day.day}</span>
                                        </div>
                                        <h4 className="text-lg font-medium text-white mb-3">{day.title}</h4>
                        ...
                        <div className="space-y-6">
                            <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
                                <h4 className="text-sm font-medium text-gray-400 mb-4 uppercase tracking-wider">Trip Stats</h4>
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="font-semibold text-white">{trip.stats.placesVisited} Spots</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="font-semibold text-white">{trip.stats.distance}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <div className="p-6 rounded-2xl bg-gradient-to-br from-teal-900/20 to-teal-800/20 border border-teal-500/20">
                                <p className="text-sm text-teal-200/80 italic">
                                    "This was an unforgettable journey through the heart of {trip.destination.split(',')[0]}. Can't wait to go back!"
                                </p>
                            </div>
                        </div>
                    </div>
