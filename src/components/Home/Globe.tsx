...
const CITIES_DB = [
    { name: "New York", lat: 40.7128, lng: -74.0060, info: "The Big Apple" },
    ...
    { name: "Mumbai", lat: 19.0760, lng: 72.8777, info: "Gateway of India" },
    { name: "Rio de Janeiro", lat: -22.9068, lng: -43.1729, info: "Christ the Redeemer" },
    ...
    { name: "Istanbul", lat: 41.0082, lng: 28.9784, info: "Meeting of Continents" },
...
export const Globe = () => {
    ...
    const [selectedPlace, setSelectedPlace] = useState<{ name: string, info: string } | null>(null);

    // Handle Resize (Listen to window for now as fallback)
    useEffect(() => {
        ...
        // Dispatch resize event initially
    ...
    const handleGlobeClick = ({ lat, lng }: { lat: number, lng: number }) => {
        ...
        if (bestCity && minDist < 8) {
            ...
            // Fly to location
            globeEl.current?.pointOfView({ lat: city.lat, lng: city.lng, altitude: 1.8 }, 1500);
        } else {
